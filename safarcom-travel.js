        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/safarcomtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    ...
    {
        title: 'عروض تايلاند',
        image_1: ['مكتب-سياحي-بحريني/عروض-تايلاند/عرض-تايلاند-1.jpg', 'عرض بوكيت & كرابي'],
        image_2: ['مكتب-سياحي-بحريني/عروض-تايلاند/عرض-تايلاند-2.jpg', 'عرض بوكيت & بتايا & بانكوك'],
        image_3: ['مكتب-سياحي-بحريني/عروض-تايلاند/عرض-تايلاند-3.jpg', 'عرض بوكيت & بتايا & بانكوك & كرابي'],
        image_4: ['مكتب-سياحي-بحريني/عروض-تايلاند/عرض-تايلاند-4.jpg', 'عرض بوكيت & بانكوك'],
    },

    {
        title: 'عروض لندن',
        image_1: ['مكتب-سياحي-بحريني/عروض-لندن/عرض-لندن-1.jpg', 'عروض فصل الربيع - لندن 6 أيام'],
    },

    {
        title: 'عروض موسكو',
        image_1: ['مكتب-سياحي-بحريني/عروض-موسكو/عرض-موسكو-1.jpg', 'عروض فصل الربيع - موسكو 6 أيام'],
    },

    {
        title: 'عروض المالديف',
        image_1: ['مكتب-سياحي-بحريني/عروض-المالديف/عرض-المالديف-1.jpg', 'عروض فصل الربيع - المالديف 5 أيام'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['مكتب-سياحي-بحريني/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'عروض فصل الربيع - ماليزيا 10 أيام'],
        image_2: ['مكتب-سياحي-بحريني/عروض-ماليزيا/عرض-ماليزيا-2.jpg', 'عروض فصل الشتاء - ماليزيا 10 أيام'],
    },

    {
        title: 'عروض سنغافورة',
        image_1: ['مكتب-سياحي-بحريني/عروض-سنغافورة/عرض-سنغافورة-1.jpg', 'عروض فصل الربيع - سنغافورة 6 أيام'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['مكتب-سياحي-بحريني/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'عرض اندونيسيا - بونشاك & جاكرتا'],
        image_2: ['مكتب-سياحي-بحريني/عروض-اندونيسيا/عرض-اندونيسيا-2.jpg', 'عرض اندونيسيا - بونشاك & بالي & جاكرتا'],
        image_3: ['مكتب-سياحي-بحريني/عروض-اندونيسيا/عرض-اندونيسيا-3.jpg', 'عرض اندونيسيا - جاكرتا & بالي & بونشاك'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['مكتب-سياحي-بحريني/عروض-جورجيا/عرض-جورجيا-1.jpg', 'عروض فصل الربيع - جورجيا 8 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97333789171?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/safarcomtravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا سفركم على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة سفركم على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة سفركم على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا شركة سفركم للسياحة والسفر 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة سفركم للسياحة والسفر ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة سفركم`;
            img.title = `مكتب سياحي - شركة سفركم`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97333789171";
